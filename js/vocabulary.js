...
const DEMO_VOCABULARY = [
  ...
  { word: 'apple', meaning: '蘋果', pos: 'noun', level: 1, sentence: 'I eat an apple every day.' },
  { word: 'book', meaning: '書', pos: 'noun', level: 1, sentence: 'This book is very interesting.' },
  { word: 'cat', meaning: '貓', pos: 'noun', level: 1, sentence: 'The cat is sleeping on the sofa.' },
  { word: 'dog', meaning: '狗', pos: 'noun', level: 1, sentence: 'My dog likes to play in the park.' },
  { word: 'eat', meaning: '食', pos: 'verb', level: 1, sentence: 'We eat lunch at twelve o\'clock.' },
  { word: 'fish', meaning: '魚', pos: 'noun', level: 1, sentence: 'There are many fish in the sea.' },
  { word: 'good', meaning: '好', pos: 'adjective', level: 1, sentence: 'You did a good job on your test.' },
  { word: 'happy', meaning: '開心', pos: 'adjective', level: 1, sentence: 'I feel very happy today.' },
  { word: 'jump', meaning: '跳', pos: 'verb', level: 1, sentence: 'The rabbit can jump very high.' },
  { word: 'king', meaning: '國王', pos: 'noun', level: 1, sentence: 'The king lives in a big castle.' },
  { word: 'love', meaning: '愛', pos: 'verb', level: 2, sentence: 'I love my family very much.' },
  { word: 'moon', meaning: '月亮', pos: 'noun', level: 2, sentence: 'The moon is bright tonight.' },
  { word: 'name', meaning: '名', pos: 'noun', level: 2, sentence: 'Please write your name on the paper.' },
  { word: 'open', meaning: '打開', pos: 'verb', level: 2, sentence: 'Please open your book to page 10.' },
  { word: 'play', meaning: '玩', pos: 'verb', level: 2, sentence: 'I play basketball after school.' },
  { word: 'quick', meaning: '快', pos: 'adjective', level: 2, sentence: 'Be quick or we will be late.' },
  { word: 'run', meaning: '跑', pos: 'verb', level: 2, sentence: 'I run every morning before school.' },
  { word: 'sun', meaning: '太陽', pos: 'noun', level: 2, sentence: 'The sun is shining very brightly.' },
  { word: 'tree', meaning: '樹', pos: 'noun', level: 2, sentence: 'There is a big tree in the garden.' },
  { word: 'water', meaning: '水', pos: 'noun', level: 2, sentence: 'I drink a lot of water every day.' },
  // Level 3-5 (well-tested) — intermediate
  { word: 'beautiful', meaning: '美麗', pos: 'adjective', level: 3, sentence: 'The sunset is very beautiful.' },
  { word: 'celebrate', meaning: '慶祝', pos: 'verb', level: 3, sentence: 'We celebrate Christmas every year.' },
  { word: 'discover', meaning: '發現', pos: 'verb', level: 3, sentence: 'Scientists discover new things every day.' },
  { word: 'elephant', meaning: '大笨象', pos: 'noun', level: 3, sentence: 'An elephant is the largest land animal.' },
  { word: 'friendly', meaning: '友善', pos: 'adjective', level: 3, sentence: 'My new classmates are very friendly.' },
  { word: 'garden', meaning: '花園', pos: 'noun', level: 3, sentence: 'My mother grows flowers in the garden.' },
  { word: 'honest', meaning: '誠實', pos: 'adjective', level: 3, sentence: 'It is important to be honest.' },
  { word: 'imagine', meaning: '想像', pos: 'verb', level: 4, sentence: 'Can you imagine a world without trees?' },
  { word: 'journey', meaning: '旅程', pos: 'noun', level: 4, sentence: 'The journey to school takes thirty minutes.' },
  { word: 'kitchen', meaning: '廚房', pos: 'noun', level: 4, sentence: 'My mother is cooking in the kitchen.' },
  { word: 'library', meaning: '圖書館', pos: 'noun', level: 4, sentence: 'I borrow books from the library every week.' },
  { word: 'mountain', meaning: '山', pos: 'noun', level: 4, sentence: 'We climbed the mountain last weekend.' },
  { word: 'natural', meaning: '自然', pos: 'adjective', level: 4, sentence: 'This is made from natural materials.' },
  { word: 'opinion', meaning: '意見', pos: 'noun', level: 5, sentence: 'In my opinion, this is the best answer.' },
  { word: 'patient', meaning: '耐心', pos: 'adjective', level: 5, sentence: 'You need to be patient and wait your turn.' },
  { word: 'quickly', meaning: '快速地', pos: 'adverb', level: 5, sentence: 'Please finish your homework quickly.' },
  { word: 'remember', meaning: '記住', pos: 'verb', level: 5, sentence: 'Remember to bring your textbook.' },
  { word: 'strange', meaning: '奇怪', pos: 'adjective', level: 5, sentence: 'I heard a strange noise last night.' },
  { word: 'thousand', meaning: '一千', pos: 'number', level: 5, sentence: 'There are over a thousand students in our school.' },
  { word: 'usually', meaning: '通常', pos: 'adverb', level: 5, sentence: 'I usually wake up at seven o\'clock.' },
  // Level 6 (mastered) — advanced
  { word: 'adventure', meaning: '冒險', pos: 'noun', level: 6, sentence: 'Reading is an amazing adventure.' },
  { word: 'brilliant', meaning: '輝煌', pos: 'adjective', level: 6, sentence: 'That was a brilliant idea!' },
  { word: 'curious', meaning: '好奇', pos: 'adjective', level: 6, sentence: 'I am curious about how computers work.' },
  { word: 'dangerous', meaning: '危險', pos: 'adjective', level: 6, sentence: 'It is dangerous to play near the road.' },
  { word: 'education', meaning: '教育', pos: 'noun', level: 6, sentence: 'Education changes lives.' },
  { word: 'furniture', meaning: '傢俬', pos: 'noun', level: 6, sentence: 'We bought new furniture for the living room.' },
  { word: 'generous', meaning: '慷慨', pos: 'adjective', level: 6, sentence: 'My grandmother is very generous.' },
  { word: 'horrible', meaning: '可怕', pos: 'adjective', level: 6, sentence: 'The weather was horrible yesterday.' },
  { word: 'important', meaning: '重要', pos: 'adjective', level: 6, sentence: 'Education is very important.' },
  { word: 'knowledge', meaning: '知識', pos: 'noun', level: 6, sentence: 'Knowledge is power.' },
];
