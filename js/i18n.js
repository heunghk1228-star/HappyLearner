...
const I18N = {
  'zh-TW': {
    ...
    english: {
      ...
      spellingMode: '串字模式',
      spellingModeDesc: '全部題目都係串字題（聽寫）',
      mixedMode: '串字+填充模式',
      mixedModeDesc: '新手級串字，已鞏固或以上會出填充題',
      cached: '已快取',
      hint: '提示',
      listen: '聆聽',
      nextQuestion: '下一題',
  ...
  'zh-CN': {
    ...
    english: {
      ...
      spellingMode: '串字模式',
      spellingModeDesc: '全部题目都是串字题（听写）',
      mixedMode: '串字+填充模式',
      mixedModeDesc: '新手级串字，已巩固或以上会出填充题',
      cached: '已缓存',
      hint: '提示',
      listen: '聆听',
      nextQuestion: '下一题',
  ...
  en: {
    ...
    english: {
      ...
      spellingMode: 'Full Spelling',
      spellingModeDesc: 'All questions are spelling (listen & type)',
      mixedMode: 'Spelling + Fill-blank',
      mixedModeDesc: 'Newbee = spelling, Well-tested+ = fill-in-the-blank',
      cached: 'Cached',
      hint: 'Hint',
      listen: 'Listen',
      ...
      loginPromptSub: 'Try the demo account to explore all features',
      welcome: 'Welcome',
      loading: 'Loading...',
      verb: 'Verb',
      noun: 'Noun',
